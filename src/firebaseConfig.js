...
const firebaseConfig = {
  ...
  authDomain: process.env.FIREBASE_AUTH_DOMAIN || "zenith-301b7.firebaseapp.com",
  projectId: process.env.FIREBASE_PROJECT_ID || "zenith-301b7",
  storageBucket: process.env.FIREBASE_STORAGE_BUCKET || "zenith-301b7.appspot.com",
